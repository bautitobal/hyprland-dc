...
# like this: https://weather.com/en-IN/weather/today/l/2447e41747ecf3ceead70ef4a5d89867e3a9cb3f1e92b0ddfce326652eb6c46e
# once you get the location_id, you can replace the below location_id with your own location_id
location_id = "2447e41747ecf3ceead70ef4a5d89867e3a9cb3f1e92b0ddfce326652eb6c46e" # In my case, it's Argentina, Buenos Aires
...
parser.add_argument("-o", "--open-url", action="store_true", help="Open weather URL in browser")
args = parser.parse_args()

# If -o is passed, open the weather URL
if args.open_url:
